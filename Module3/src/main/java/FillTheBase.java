...
public class FillTheBase {
    ...
    public static void main(String[] args) {
        ...
        try (sessionFactory;
            ...
            secondUser.getPhotos().get(secondUser.getPhotos().size()).addLike(firstUser.getName());
            entityManager.persist(secondUser);
            entityManager.persist(firstUser);
            log.info("User {} added like to user {} photos in his profile", firstUser.getName(), secondUser.getName());
            secondUser.getPhotos().get(secondUser.getPhotos().size()).addComment(firstUser.getName(), "It's cool!");
            entityManager.persist(secondUser);
            entityManager.persist(firstUser);
            ...
            secondUser.getPhotos().get(secondUser.getPhotos().size()).addComment(secondUser.getName(), "Thank's!");
            entityManager.persist(firstUser);
            entityManager.persist(secondUser);
