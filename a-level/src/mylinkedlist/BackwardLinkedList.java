...
public class BackwardLinkedList<T> implements Iterable<T> {
    ...
    public void add(T element){
        if (isEmpty()){
            ...
            tail().previousLink(new Node<>(element));
        }
        size++;
    }
    ...
    public void addFirst(int index, T element){
        Node<T> added;
        if (index == 0){
            added = new Node<>(element, head);
            head = added;
            ...
            Node<T> previous = navigate(index - 1);
            Node<T> next = previous.previous();
            added = new Node<>(element, previous);
            previous.previousLink(added);
        }
    }
    ...
    private static final class Node<E> {
        ...
        public void previousLink(Node<E> previous){
        ...
        public void previousUnlink(){
            this.isPrevious = null;
        }
