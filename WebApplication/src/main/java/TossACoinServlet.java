 ...
 * Realize web-application that imitate the toss a coin process. On the web-page we output the results of this process:
 * heads or tails. The result value is generated by randomize and has changed when the user is updates the page.
 */
